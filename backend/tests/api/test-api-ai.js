    ...
    try {
        ...
        const analyseData = {
            ...
            document: {
                ...
                description:
                    "Développement d'une application web pour gérer les projets étudiants, incluant le suivi des livrables et la communication entre tuteurs et étudiants.",
        ...
        const analyseResponse = await axios.post(
            'http://localhost:5003/api/ai/analyze',
            analyseData
        );
        ...
        const texteFrResponse = await axios.post(
            'http://localhost:5003/api/ai/generer-texte',
            promptFr
        );
        ...
        const texteEnResponse = await axios.post(
            'http://localhost:5003/api/ai/generate-text',
            promptEn
        );
