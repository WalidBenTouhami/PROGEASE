...
const testAPI = async () => {
    try {
        ...
        const createTuteurResponse = await axios.post(
            'http://localhost:5003/api/utilisateurs',
            tuteurData
        );
        ...
        const createProjetResponse = await axios.post(
            'http://localhost:5003/api/projets',
            projetData
        );
        ...
        const createLivrableResponse = await axios.post(
            'http://localhost:5003/api/livrables',
            livrableData
        );
        ...
        console.log("\nTest de récupération des livrables d'un projet...");
        const getLivrablesByProjetResponse = await axios.get(
            `http://localhost:5003/api/projets/${projetId}/livrables`
        );
