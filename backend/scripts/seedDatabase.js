...
async function seedDatabase() {
  try {
    ...
    const users = await User.insertMany([
      { email: 'admin@example.com', role: 'admin', experience: 5, skills: ['Node.js', 'MongoDB'] },
      { email: 'tutor@example.com', role: 'tutor', experience: 3, skills: ['GraphQL', 'React'] },
      { email: 'student@example.com', role: 'student', experience: 1, skills: ['JavaScript'] },
    ]);
