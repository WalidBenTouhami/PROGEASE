...
const ressourceSchema = yup.object().shape({
    ...
    url: yup.string()
        .required('L\'URL de la ressource est requise.')
...
const progressionSchema = yup.object().shape({
    modulesCompletes: yup.array()
        .of(yup.string()
            .required('L\'ID du module est requis.')
            .test('is-mongodb-id', 'L\'ID du module est invalide.', value => mongoose.Types.ObjectId.isValid(value))
        ),
    
    quizCompletes: yup.array()
        .of(yup.string()
            .required('L\'ID du quiz est requis.')
            .test('is-mongodb-id', 'L\'ID du quiz est invalide.', value => mongoose.Types.ObjectId.isValid(value))
        ),
    
    ressourcesConsultees: yup.array()
        .of(yup.string()
            .required('L\'ID de la ressource est requis.')
            .test('is-mongodb-id', 'L\'ID de la ressource est invalide.', value => mongoose.Types.ObjectId.isValid(value))
        )
});
