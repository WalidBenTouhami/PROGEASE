...
router.post('/generer', rateLimiter({ windowMs: 60000, max: 10 }), authMiddleware, genererCertificat);

// Verifier la validite du certificat
router.get('/:certificatId/verifier', rateLimiter({ windowMs: 60000, max: 30 }), authMiddleware, verifierValiditeCertificat); 
