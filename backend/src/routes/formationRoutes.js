...
router.post("/:formationId/ajouter-utilisateur", rateLimiter({ windowMs: 60000, max: 30 }), addutilisateurToFormation); // Route pour ajouter un utilisateur à une formation
router.post("/:formationId/ajouter-module", rateLimiter({ windowMs: 60000, max: 30 }), addModuleToFormation); // Route pour ajouter un module à une formation
