...
const {
  ...
  addUserToFormation,   // Ajouter un utilisateur à une formation
...
router.post("/:formationId/ajouter-utilisateur", addUserToFormation); // Route pour ajouter un utilisateur à une formation
