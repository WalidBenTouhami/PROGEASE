          ...
          <div class="section">
            ...
            <mat-list>
              <mat-list-item>
                ...
                <div matListItemTitle>{{ projet?.etudiant.prenom }} {{ projet?.etudiant.nom }}</div>
                <div matListItemLine>{{ projet?.etudiant.email }}</div>
              </mat-list-item>
            </mat-list>
          </div>
...
export class ProjetDetailComponent implements OnInit {
  ...
  modifier(): void {
    if (this.projet) {
      this.router.navigate(['/tuteur/projets', this.projet.id, 'modifier']);
    }
  }
} 