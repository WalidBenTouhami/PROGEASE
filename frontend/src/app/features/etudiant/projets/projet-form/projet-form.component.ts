        ...
        <mat-card-content>
          <form [formGroup]="projetForm" (ngSubmit)="onSubmit()">
            ...
            <mat-form-field appearance="outline" class="full-width">
              ...
              <input matInput formControlName="nom" placeholder="Entrez le nom du projet">
            ...
            <mat-form-field appearance="outline" class="full-width">
              ...
              <textarea matInput formControlName="description" rows="4" placeholder="Entrez la description du projet"></textarea>
            ...
            <mat-form-field appearance="outline" class="full-width">
              ...
              <input matInput type="number" formControlName="progression" min="0" max="100">
            ...
            <mat-form-field appearance="outline" class="full-width">
              ...
              <input matInput [matDatepicker]="finPicker" formControlName="dateFinPrevue">
...
export class ProjetFormComponent implements OnInit {
  ...
  private chargerProjet(): void {
    ...
    this.projetForm.patchValue(projetTest);
  }

  onSubmit(): void {
    if (this.projetForm.valid) {
      const projet = this.projetForm.value;
      // TODO: Sauvegarder le projet via le service
      console.log('Projet à sauvegarder:', projet);
